                    ...
                    <tr>
                        <td>
                            <label class="form-check-label" for="check1">
                                <input type="checkbox" todo_id="{{ $data->id }}"
                                    class="form-check-input todo_check_status" id="check1" name="check"
                                    value="something" @if ($data->status == '1') checked @endif>
                            </label>


                            <input type="text" name="description" value="{{ $data->description }}"
                                class="description_todo " todo_id="{{ $data->id }}" title="click to edit">
                        ...
                        <td>
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    ...
                                    <input type="date" class="datepicker-13" todo_id="{{ $data->id }}"
                                        title="click to edit date" @if (!is_null($data->scheduled_date)) value = "{{ $data->scheduled_date }}" @endif>
                            </div>
                        </td>
                        <td>
                            <a class="btn btn-danger delete_todo" todo_id="{{ $data->id }}"><i
